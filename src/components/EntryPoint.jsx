...
export default function EntryPoint() {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-200 to-blue-300 overflow-hidden">
            {/* About Us Button */}
            <button
                className="absolute top-4 right-4 sm:top-6 sm:right-6 md:top-8 md:right-12 flex items-center gap-2 bg-white bg-opacity-60 px-4 py-2 sm:px-5 sm:py-2 rounded-full shadow hover:bg-opacity-80 transition"
                onClick={() => navigate('/about')}
            >
                <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <span className="font-medium text-gray-700 text-sm sm:text-base">About Us</span>
            </button>
